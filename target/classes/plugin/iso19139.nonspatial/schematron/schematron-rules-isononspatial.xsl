...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA SETUP-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="ISO non-spatial rules"
                              schemaVersion="">
         <xsl:comment>
        ...
        <xsl:value-of select="$fileDirParameter"/>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">
               <xsl:value-of select="$loc/strings/ISONS001"/>
            </xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">
               <xsl:value-of select="$loc/strings/ISONS002"/>
            </xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">
               <xsl:value-of select="$loc/strings/required.keyword.title"/>
            </xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">ISO non-spatial rules</svrl:text>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
  ...
  <!--RULE
      -->
<xsl:template match="//gmd:MD_AggregateInformation" priority="1000" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
  ...
  <!--RULE
      -->
<xsl:template match="//gmd:MD_ExtendedElementInformation" priority="1000" mode="M22">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
  ...
  <!--RULE
      -->
<xsl:template match="//gmd:MD_ExtendedElementInformation" priority="1000" mode="M23">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//gmd:MD_ExtendedElementInformation"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
  ...
  <!--RULE
      -->
<xsl:template match="//gmd:identificationInfo/*/gmd:abstract" priority="1008" mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:if test="$text or $nilReason">
  ...
  <!--RULE
      -->
<xsl:template match="//gmd:identificationInfo/*/gmd:citation/*/gmd:title" priority="1007"
                 mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:if test="$text or $nilReason">
  ...
  <!--RULE
      -->
<xsl:template match="/*/gmd:contact" priority="1004" mode="M27">
...
<xsl:if test="node() | @gco:nilReason">
  ...
  <!--RULE
      -->
<xsl:template match="/*/gmd:language" priority="1003" mode="M27">
...
<xsl:if test="node() | @gco:nilReason">
  ...
  <!--RULE
      -->
<xsl:template match="//gmd:identificationInfo/*/gmd:language" priority="1002" mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:if test="node() | @gco:nilReason">
  ...
  <!--RULE
      -->
<xsl:template match="/gmd:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:description"
                 priority="1001"
                 mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/gmd:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:description"/>
      <xsl:variable name="text"
                    select="(gco:CharacterString | .//gmd:LocalisedCharacterString)[normalize-space(text()) != '']"/>
      <xsl:variable name="nilReason" select="@gco:nilReason and not(./node())"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
               ...
               <svrl:text>
                  <xsl:text/>
                  <xsl:copy-of select="$loc/strings/alert.requiredDescription"/>
                  <xsl:text/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
...
<xsl:if test="node() | @gco:nilReason">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
                <xsl:text/>
               <xsl:copy-of select="$loc/strings/report.requiredDescription"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
  ...
  <!--RULE
      -->
<xsl:template match="/gmd:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:name"
                 priority="1000"
                 mode="M27">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/gmd:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource/gmd:name"/>
      <xsl:variable name="text"
                    select="(gco:CharacterString | .//gmd:LocalisedCharacterString)[normalize-space(text()) != '']"/>
      <xsl:variable name="nilReason" select="@gco:nilReason and not(./node())"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
               ...
               <svrl:text>
                  <xsl:text/>
                  <xsl:copy-of select="$loc/strings/alert.requiredName"/>
                  <xsl:text/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
...
<xsl:if test="node() | @gco:nilReason">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
                <xsl:text/>
               <xsl:copy-of select="$loc/strings/report.requiredName"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
  ...
  <!--RULE
      -->
<xsl:template match="//gmd:identificationInfo/*/gmd:citation" priority="1000" mode="M28">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:if test="gmd:CI_Citation | @gco:nilReason">
   ...
   <!--PATTERN
        $loc/strings/ISONS001-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
      <xsl:copy-of select="$loc/strings/ISONS001"/>
   </svrl:text>
...
<xsl:template match="/gmd:MD_Metadata/gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource"
      ...
      -->
<xsl:choose>
         <xsl:when test="count(./gmd:description)=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="count(./gmd:description)=1">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                  <xsl:copy-of select="$loc/strings/ISONS001.alert.desc"/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <!--REPORT
      -->
<xsl:if test="count(./gmd:description)=1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                 test="count(./gmd:description)=1">
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            <svrl:text>
               <xsl:copy-of select="$loc/strings/ISONS001.required.desc"/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M29"/>
   ...
   <!--PATTERN
        $loc/strings/ISONS002-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
      <xsl:copy-of select="$loc/strings/ISONS002"/>
   </svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
               ...
               <svrl:text>
                  <xsl:copy-of select="$loc/strings/ISONS002.alert.name"/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:if test="count(./gmd:name)=1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
               <xsl:copy-of select="$loc/strings/ISONS002.required.name"/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M30"/>
   ...
   <!--PATTERN
        $loc/strings/required.keyword.title-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
      <xsl:copy-of select="$loc/strings/required.keyword.title"/>
   </svrl:text>
...
<xsl:template match="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords"
                 ...
                 mode="M31">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords"/>
      <xsl:variable name="kw"
                    select="count(./gmd:keyword/gco:CharacterString/text()[contains(.,'NonSpatial')])"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
               ...
               <svrl:text>
                  <xsl:copy-of select="$loc/strings/required.keyword.alert"/>
               </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:if test="$kw = 1">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
               <xsl:copy-of select="$loc/strings/required.keyword.report"/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M31"/>
